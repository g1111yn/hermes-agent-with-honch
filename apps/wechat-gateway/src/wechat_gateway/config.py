...
class GatewayConfig:
    ...
    debounce_max_wait_seconds: float
    ...
    def from_env(cls) -> "GatewayConfig":
        ...
        return cls(
            ...
            bridge_driver=os.getenv("WECHAT_BRIDGE_DRIVER", "gewechat").strip().lower() or "gewechat",
            ...
            binding_store_path=os.getenv("WECHAT_GATEWAY_BINDING_STORE", str(state_dir / "bindings.json")).strip(),
            ...
            debounce_seconds=float(os.getenv("WECHAT_DEBOUNCE_SECONDS", "3.58")),
            debounce_max_wait_seconds=float(os.getenv("WECHAT_DEBOUNCE_MAX_WAIT_SECONDS", "15.0")),
        )
